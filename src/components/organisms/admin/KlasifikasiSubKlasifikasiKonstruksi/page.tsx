...
const KlasifikasiSubKlasifikasiKons = () => {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:8000/api/klasifikasi")
      .then((response) => {
  ...
  const handleSubmitSubKlasifikasi = async (e) => {
    ...
    try {
      await axios.post(
        `http://localhost:8000/api/klasifikasis/${selectedKlasifikasi}/sub-klasifikasis`,
        {
  ...
  return (
    <div className="p-8">
      <h1 className="text-2xl font-bold mb-6">
        Manajemen Klasifikasi & SubKlasifikasi
      </h1>
...
export default KlasifikasiSubKlasifikasiKons;
