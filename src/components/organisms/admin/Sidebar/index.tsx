      ...
      >
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-gray-200 dark:border-gray-700">
          ...
          <button
            ...
            className="lg:hidden text-gray-500 dark:text-gray-300 hover:text-red-500 transition"
        ...
        <div className="p-4 border-t border-gray-200 dark:border-gray-700">
          <button
            onClick={onLogout}
            className="flex w-full items-center justify-center gap-2 rounded-lg bg-white dark:bg-gray-800 border px-4 py-2 text-sm font-semibold text-red-600 hover:bg-red-100 dark:hover:bg-red-700 hover:shadow-md transition"
          >
