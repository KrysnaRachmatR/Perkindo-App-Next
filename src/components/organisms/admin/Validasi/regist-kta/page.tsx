      ...
      <table className="table-auto w-full border-collapse border border-gray-200">
        ...
        <tbody>
          {activeKTAs.length > 0 ? (
            ...
            <tr>
              <td colSpan={6} className="text-center border border-gray-200 px-4 py-2">
     ...
     {detailData && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center">
          <div className="p-6 rounded-lg shadow-2xl w-[500px] relative bg-gradient-to-r from-blue-600 to-purple-700 text-white">
            <h3 className="text-2xl font-extrabold mb-4">Detail KTA {detailData.nama_perusahaan}</h3>
              ...
              <p><strong>Kota/Kabupaten :</strong> {detailData.kota_kabupaten}</p>
              <p><strong>Status :</strong> {detailData.status_aktif}</p>
          </div>
          <button
            onClick={closeModal}
