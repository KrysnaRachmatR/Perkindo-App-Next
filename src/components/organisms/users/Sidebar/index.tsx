...
const menuGroups = [
  {
    ...
    menuItems: [
      ...
      },
      {
        ...
        route: "#",
        children: [
          { label: "SBU-Konstruksi", route: "/users/SBU/Konstruksi" },
          {
            label: "SBU-Non Konstruksi",
            route: "/users/SBU/NonKonstruksi",
          },
        ],
      },
    ],
...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    <ClickOutside onClick={() => setSidebarOpen(false)}>
      <aside
        className={`fixed left-0 top-0 z-[9999] flex h-screen w-72 flex-col overflow-y-hidden bg-[#ffff] drop-shadow-md shadow-2 duration-300 ease-linear dark:bg-boxdark lg:translate-x-0 ${
          sidebarOpen ? "translate-x-0" : "-translate-x-full"
        }`}
      >
        {/* <!-- SIDEBAR HEADER --> */}
        <div className="flex gap-2 mt-2 px-6 py-5 lg:py-6.5">
          <Link href="/" className="flex items-center">
            <Image
              ...
              priority
            />
            <h1 className="ml-2 text-3xl font-medium text-black space tracking-[0.1rem] dark:text-white">
              PERKINDO
            </h1>
          </Link>
          ...
          >
            <svg
              className="fill-current text-black ml-2 dark:text-white"
              width="20"
              height="18"
              viewBox="0 0 20 18"
              fill="none"
